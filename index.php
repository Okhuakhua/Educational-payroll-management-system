...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <div class="masthead">
        ...
        <nav>
          <ul class="nav nav-justified">
            ...
            <li><a href="home_allowance.php">Allowance</a></li>
      ...
      <p><a data-toggle="modal" class="btn btn-lg btn-success" href="#" role="button">Software Created by OMOIYEBAGBE FAVOUR OSEREMEN</a></p>
    </div>

      <!-- Site footer -->
      <footer class="footer">
        <p align="center">&copy; All Rights Reserved 2019</p>
        <p align="center">Copyright by <a target="_blank" href"#" data-show-count="true">OMOIYEBAGBE FAVOUR OSEREMEN</a></p>
      ...
      <div class="modal fade" id="instructor" role="dialog">
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-body" style="padding:40px 50px;">
            <div align="center">
              <a href="#" target="_blank" title="My Instructor in OOP2"><big><b> OMOIYEBAGBE FAVOUR OSEREMEN</b></big></a>
            </div>
          </div>
        </div>
      </div>
