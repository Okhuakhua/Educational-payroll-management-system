      ...
      <div class="masthead">
        ...
        <nav>
          <ul class="nav nav-justified">
            ...
            <li>
              <a href="home_allowance.php">Allowance</a>
            </li>
            <li class="active">
              <a href="">Income</a>
            </li>
                    ...
                    <table class="table table-bordered table-hover table-condensed" id="myTable">
                      ...
                      <thead>
                        <tr class="info">
                          ...
                          <th><p align="center">Allowance</p></th>
                      ...
                      <tbody>
                        <?php
                          ...
                          while($row=mysql_fetch_array($query))
                          {
                            ...
                            $deduction  = $row['deduction'];
                            $allowance  = $row['allowance'];
                            $income   = $over + $bonus + $allowance + $salary_rate;
                        ...
                        <tr>
                          ...
                          <td align="center"><big><b><?php echo $allowance?></b></big>.00</td>
