...
?>
<?php
  $sql = mysql_query("SELECT * from allowance WHERE allowance_id='1'");
  while($row = mysql_fetch_array($sql))
  {
    $id           = $row['allowance_id'];
    ...
    <div class="container">
      <div class="masthead">
        ...
        <nav>
          <ul class="nav nav-justified">
            ...
            <li>
              <a href="home_allowance">Allowance</a>
            </li>
            <li>
      ...
      <?php
        ...
        while ($row = mysql_fetch_assoc($result))
        {
            ...
            $income   = $overtime + $bonus + $allowance + $salary;
          ...
          ?>
              ...
              <form class="form-horizontal" action="update_account.php" method="post" name="form">
                ...
                <input name="id" type="hidden" value="<?php echo $row['emp_id'];?>" />
                  ...
                  <div class="form-group">
                    <label class="col-sm-5 control-label">Allowance  :</label>
                    <div class="col-sm-4">
                    <select name="deduction" class="form-control" required>
                      <option value=""><?php echo $row['allowance'];?></option>
                      <option value="<?php echo $transport; ?>">Transport</option>
                      <option value="<?php echo $meal; ?>">Meal</option>
                      <option value="<?php echo $housing; ?>">Housing</option>
                      <option value="<?php echo $ltg; ?>">LTG</option>
